Configuration NewExchangeServer
 
{
    ...
    Node $AllNodes.Where{$_.Role -contains"EXCHANGE-SERVER"}.Nodename
    {
        $DomainCreds = New-Object System.Management.Automation.PSCredential ("Administrator", (ConvertTo-SecureString $ConfigurationData.ScenarioData.DomainAdminPassword -AsPlainText -Force))
        ...
        # Download UCMA from URL
        xRemoteFile DownloadUCMA
        {
            DestinationPath = "C:\UcmaRuntimeSetup\UcmaRuntimeSetup.exe"
            Uri = $AllNodes.UCMA_EXE 
        }
        ...
        Package UCMA
        {
            ...
            Name = 'Microsoft Unified Communications Managed API 4.0, Core
                    Runtime 64-bit'
            Path= "C:\UcmaRuntimeSetup\UcmaRuntimeSetup.exe"
            ProductID= $AllNodes.UCMA_EXE_PRODUCTID 
            Arguments= '/q'
        ...
        {
            DestinationPath = "C:\Exchange\Exchange.exe"
            Uri = $AllNodes.EXCHANGE_EXE
        }
        ...
        File ExchangeBinaries
        {
            ...
            Type            = 'Directory'
            Recurse         = $false
            SourcePath = 'C:\Exchange'
            DestinationPath = 'C:\Exchange'
        }
        ...
        {
            Path       = "C:\Exchange\Exchange.exe"
            Arguments  = "/mode:Install /role:Mailbox /OrganizationName:""starindustries"" /Iacceptexchangeserverlicenseterms"
        ...
        xPendingReboot RebootAfterExchangeInstall
        {
            Name      = "RebootAfterExchangeInstall"
